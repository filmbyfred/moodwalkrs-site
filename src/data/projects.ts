...
export const allProjects: Project[] = [
  ...
  },
  {
    ...
    tag: "Client",
    client: "BETC / Saudi",
    role: "AI Moodfilm · Production",
    year: 2026,
    cover: "/films/saudi-not-a-football-country-poster.jpg",
    preview: "/films/saudi-not-a-football-country-preview.mp4",
    video: "/films/saudi-not-a-football-country.mp4",
    description: "AI moodfilm built from a BETC brief — Saudi football culture, shot through a cinematic AI lens.",
    gallery: [],
    span: "lg",
    ratio: "16:9",
    private: true
  ...
  {
    title: "Saudi — Not Madness",
    slug: "saudi-not-madness",
    category: "BETC Commercial",
    tag: "Client",
    client: "BETC / Saudi",
    role: "AI Moodfilm · Production",
    year: 2026,
    cover: "/films/saudi-not-madness-poster.jpg",
    preview: "/films/saudi-not-madness-preview.mp4",
    video: "/films/saudi-not-madness.mp4",
    description: "Second AI moodfilm in the Saudi series — exploring intensity and obsession through hybrid imagery.",
    gallery: [],
    span: "md",
    ratio: "16:9",
    private: true
  },
  {
    ...
    role: "AI Moodfilm · Direction",
    year: 2026,
    cover: "/films/peugeot-e208-poster.jpg",
    preview: "/films/peugeot-e208-preview.mp4",
    video: "/films/peugeot-e208.mp4",
    description: "AI-driven moodfilm for the Peugeot e-208 — urban, electric, design-forward.",
    gallery: [],
    span: "lg",
    ratio: "16:9",
    private: true
  },
  {
    ...
    role: "AI Moodfilm · Direction",
    year: 2026,
    cover: "/films/oreo-poster.jpg",
    preview: "/films/oreo-preview.mp4",
    video: "/films/oreo.mp4",
    description: "Brand moodfilm for Oreo — playful, surreal, signature blue.",
    gallery: [],
    span: "md",
    ratio: "16:9",
    private: true
  },
  {
    ...
    role: "AI Moodfilm · Direction",
    year: 2026,
    cover: "/films/danone-poster.jpg",
    preview: "/films/danone-preview.mp4",
    video: "/films/danone.mp4",
    description: "AI moodfilm for Danone — texture, freshness, brand language in motion.",
    gallery: [],
    span: "md",
    ratio: "16:9",
    private: true
  },
  {
    title: "Sonepar",
    slug: "sonepar",
    category: "B2B Brand Film",
    tag: "Client",
    client: "Sonepar",
    role: "AI Moodfilm · Direction",
    year: 2026,
    cover: "/films/sonepar-poster.jpg",
    preview: "/films/sonepar-preview.mp4",
    video: "/films/sonepar.mp4",
    description: "Brand moodfilm for Sonepar — electrification, networks, industrial poetry.",
    gallery: [],
    span: "md",
    ratio: "16:9",
    private: true
